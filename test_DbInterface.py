...
# TEST: add bots
btokens = [bots.add_bot(db, 101, cache=cache), bots.add_bot(db, 33, cache=cache), bots.add_bot(db, 101, cache=cache)]
print(btokens)
print(bots.list_bots(db))
print(bots.list_bots_by_building(db, 101))
print(bots.where_is_bot(db, btokens[-1], cache=cache))
